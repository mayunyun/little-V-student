//
//  OrderManageExitTableViewCell.m
//  EveryDayBenefitSale
//
//  Created by 邱 德政 on 17/1/20.
...
#import "OrderManageExitProlistModel.h"

@interface OrderManageExitTableViewCell()<UITableViewDelegate,UITableViewDataSource>
{
    UITableView* _tbView;
}
@end

@implementation OrderManageExitTableViewCell
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    OrderManageExitProlistModel* model = [[OrderManageExitProlistModel alloc]init];
...
//    NSString* datastr = [self separateDateStr:model.sendtime];
//    cell.dataLabel.text = [NSString stringWithFormat:@"%@",datastr];
    cell.countLabel.text = [NSString stringWithFormat:@"%@",model.exitecount];
    cell.priceLabel.text = [NSString stringWithFormat:@"%@元",model.exitemoney];
    [cell setNeedsLayout];
