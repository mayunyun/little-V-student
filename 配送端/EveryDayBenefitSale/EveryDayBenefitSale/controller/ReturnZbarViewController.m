...
@interface ReturnZbarViewController ()

@end

@implementation ReturnZbarViewController
...
- (void)captureOutput:(AVCaptureOutput *)captureOutput didOutputMetadataObjects:(NSArray *)metadataObjects fromConnection:(AVCaptureConnection *)connection
{
    ...
    [self dismissViewControllerAnimated:YES completion:^
     {
         [timer invalidate];
//         if ([self.zarStatus integerValue] == 0) {
//             NSLog(@"开始退货%@",stringValue);
//         }else if([self.zarStatus integerValue] == 1){
//             NSLog(@"退货完成%@",stringValue);
//         }
         if (_transVaule) {
