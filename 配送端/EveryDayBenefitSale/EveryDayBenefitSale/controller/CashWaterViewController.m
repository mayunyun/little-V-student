...
//            _cashnoTextField.delegate = self;
            ...
            [_stutasBtn setTitle:_orderstatusArray[0] forState:UIControlStateNormal];
            _orderselectFlag = @"0";
...
- (void) niDropDownDelegateMethod: (NIDropDown *) sender index:(NSInteger)index{
    [self rel];
    _orderselectFlag = [NSString stringWithFormat:@"%i",index];
...
- (void)dataRequest
{
    ...
    NSDictionary* parmas = @{@"mobile":@"true",@"data":datastr,@"page":[NSString stringWithFormat:@"%i",_page],@"rows":@"20",@"flag":@"1"};
