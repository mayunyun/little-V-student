...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tableView == _tbView) {
        ...
        if (!IsEmptyValue(_dataArray)) {
            ...
            NSString* senderprofit = [NSString stringWithFormat:@"%@",model.distributeprofit];
...
- (void)searchfeesRequestData
{
    ...
    NSString* datastr = [NSString stringWithFormat:@"{\"distributeid\":\"%@\",\"page\":\"%@\",\"rows\":\"20\"}",userid,[NSString stringWithFormat:@"%li",(long)_page]];
