        ...
        if (!IsEmptyValue(_dataArray)) {
            {
                ...
                cell.nameLabel.text = [NSString stringWithFormat:@"%@",model.distributename];
...
- (void)dataRequest
{
    ...
    NSString* datastr = [NSString stringWithFormat:@"{\"distributeid\":\"%@\",\"page\":\"%li\",\"rows\":\"20\"}",userid,(long)_page];
