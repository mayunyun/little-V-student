//
//  MoneyDetailTHProViewController.m
//  EveryDayBenefitSale
//
//  Created by 邱 德政 on 17/1/11.
...
@interface MoneyDetailTHProViewController ()<UITableViewDelegate,UITableViewDataSource,OrderDetailNameDelegate,UIScrollViewDelegate>
{
...
@implementation MoneyDetailTHProViewController
...
- (void)dataRequest
{
     ...
     */
    [_hud show:YES];
    NSString* urlstr = [NSString stringWithFormat:@"%@%@",ROOT_Path,@"/send/searchExiteDetail.do"];
