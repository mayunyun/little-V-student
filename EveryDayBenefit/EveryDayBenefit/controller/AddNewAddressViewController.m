...
@interface AddNewAddressViewController ()<UITextFieldDelegate,UITextViewDelegate,UITableViewDelegate,UITableViewDataSource,UIScrollViewDelegate>
{
...
- (void)creatUI
{
    ...
    if ([self isExiteEcode]) {
        NSString* addr = [NSString stringWithFormat:@"%@%@%@%@",self.selectAddModel.province,self.selectAddModel.city,self.selectAddModel.area,self.selectAddModel.servicecenter];
        [_addressSelectBtn setTitle:addr forState:UIControlStateNormal];
    }else{
    ...
    UIView* thirdcellView;
    if ([self isExiteEcode]) {
       thirdcellView  = [[UIView alloc]initWithFrame:CGRectMake(0, firstcellView.bottom+10, mScreenWidth, cellHight)];
    }else{
        ...
        thirdcellView = [[UIView alloc]initWithFrame:CGRectMake(0, secondcellView.bottom+10, mScreenWidth, cellHight)];
    }
...
//    NSLog(@"地址选择器返回值%@",showMsg);
    ...
    NSString* sevicecenter_id;
    NSString* village_id;
    NSString* comunity_id;
    NSString* roomnumber_id;
    NSString* detailaddr;
    NSString* invitecode;
    if ([self isExiteEcode]) {
        
        province_id= [NSString stringWithFormat:@"%@",_selectAddModel.provinceid];
        city_id = [NSString stringWithFormat:@"%@",_selectAddModel.cityid];
        district_id = [NSString stringWithFormat:@"%@",_selectAddModel.areaid];
        sevicecenter_id = [NSString stringWithFormat:@"%@",_selectAddModel.serviceid];
        invitecode = [NSString stringWithFormat:@"%@",_selectAddModel.linkerid];
    }else{
        province_id = _addmodel.province_id;
        city_id = _addmodel.city_id;
        district_id = _addmodel.district_id;
        sevicecenter_id = _addmodel.sevicecenter_id;
        invitecode = _linkerBtnID;
      }
    village_id = _villageaddmodel.village_id;
    comunity_id = _villageaddmodel.comunity_id;
    roomnumber_id = _villageaddmodel.roomnumber_id;
    detailaddr = _addrDetailTextField.text;
        BOOL isaddrTotal;
        if ([NSString stringWithFormat:@"%@",province_id].length != 0&&[NSString stringWithFormat:@"%@",city_id].length != 0&&[NSString stringWithFormat:@"%@",district_id].length != 0&&[NSString stringWithFormat:@"%@",sevicecenter_id].length != 0&&[NSString stringWithFormat:@"%@",detailaddr].length != 0&&[NSString stringWithFormat:@"%@",village_id].length != 0&&[NSString stringWithFormat:@"%@",comunity_id].length != 0&&[NSString stringWithFormat:@"%@",roomnumber_id].length != 0) {
            isaddrTotal = YES;
        }else{
            isaddrTotal = NO;
    ...
    if (isaddrTotal) {
        if (![[NSString stringWithFormat:@"%@",invitecode] isEqualToString:@""]) {
            ...
            NSString* datastr = [NSString stringWithFormat:@"{\"custid\":\"%@\",\"provinceid\":\"%@\",\"cityid\":\"%@\",\"areaid\":\"%@\",\"serviceid\":\"%@\",\"villageid\":\"%@\",\"xiaoqu\":\"%@\",\"louhao\":\"%@\",\"address\":\"%@\",\"isdefault\":\"%@\",\"invitecode\":\"%@\"}",userid,province_id,city_id,district_id,sevicecenter_id,village_id,comunity_id,roomnumber_id,detailaddr,isdefault,invitecode];
