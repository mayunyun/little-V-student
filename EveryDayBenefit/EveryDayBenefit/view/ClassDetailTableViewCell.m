...
- (void)initView{
    ...
    _imgView = [[UIImageView alloc] initWithFrame:CGRectMake(10*MYWIDTH, 10*MYWIDTH, 45*MYWIDTH, 45*MYWIDTH)];
    _imgView.contentMode = UIViewContentModeScaleAspectFit;
    [self.contentView addSubview:_imgView];
    
    _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(_imgView.right , 0, self.width - 65*MYWIDTH, 25*MYWIDTH)];
    _titleLabel.font = [UIFont systemFontOfSize:13*MYWIDTH];
    _titleLabel.numberOfLines = 0;
    [self.contentView addSubview:_titleLabel];
    
    _saleCountLabel = [[UILabel alloc]initWithFrame:CGRectMake(_titleLabel.left, _titleLabel.bottom, 100*MYWIDTH, 20*MYWIDTH)];
    ...
    _priceLabel = [[UILabel alloc]initWithFrame:CGRectMake(_titleLabel.left, _saleCountLabel.bottom, 60*MYWIDTH, 20*MYWIDTH)];
