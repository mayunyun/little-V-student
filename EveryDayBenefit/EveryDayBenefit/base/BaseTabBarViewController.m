...
- (void)initVC
{
    ...
    HomeNewViewController *homVC = [[HomeNewViewController alloc]init];
//    HomeViewController *homVC = [[HomeViewController alloc]init];
    ...
    FindViewController *listVC = [[FindViewController alloc]init];
    ...
    //    MyNavViewController* messageNav = [[MyNavViewController alloc]initWithRootViewController:messageVC];
    //    messageNav.tabBarItem.enabled = YES;
    //    messageVC.title = @"资讯";
    
//    BuyCarVC *assetVC = [[BuyCarVC alloc]init];
    BuyCarViewController* assetVC = [[BuyCarViewController alloc]init];
    BaseNavViewController *assetNav = [[BaseNavViewController alloc]initWithRootViewController:assetVC];
